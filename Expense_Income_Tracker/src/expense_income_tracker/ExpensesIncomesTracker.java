...
public class ExpensesIncomesTracker extends JFrame{
    ...
    private double balance;                 //Current balance based on the added expenses and incomes.
    
    //Constructor to initialize the application and set up the form.
    public ExpensesIncomesTracker(){
        
        try{
            //Apply the FlatDarkLaf look and feel for a modern and flat appreance
        ...
        //Initialize the table model and balance variables
        balance= 0.0;
        tableModel= new ExpenseIncomeTableModel();
        
        //Create a JTable and set up a scroll pane to display data.
        table= new JTable(tableModel);
        JScrollPane scrollPane= new JScrollPane(table);
        table.setFillsViewportHeight(true);
        
        //Ctreate input fields and components for adding new entries.
